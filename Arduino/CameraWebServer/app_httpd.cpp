...
static String sendPhotoToServer(camera_fb_t * fb, String filename) {
  String getAll;
...
static void savePicture(camera_fb_t * fb, String filename){
...
static esp_err_t index_handler(httpd_req_t *req){
    ...
    return httpd_resp_send(req, (const char *)index_html_gz, index_html_len); 
}
